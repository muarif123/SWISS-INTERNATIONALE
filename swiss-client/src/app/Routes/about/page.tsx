        ...
        <div className='dark:bg-gray-800'>
                ...
                <div className="max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
                    <div className="flex flex-wrap ">
                        ...
                        <div  className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 rounded-3xl overflow-hidden">
                            <img style={{transition:".3s linear"}} src="https://images.unsplash.com/photo-1524842495237-6abc737eae1f?q=80&w=1946&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt=""
            ...
            <section style={{borderBottom:'1px solid'}} className="flex items-center  bg-stone-100 xl:h-screen font-poppins dark:bg-gray-800  ">
                <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
                    ...
                    <div className="flex flex-wrap ">
                        <div  className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 rounded-3xl overflow-hidden">
                            <img style={{transition:'.3s linear'}} src="https://images.unsplash.com/photo-1511068797325-6083f0f872b1?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt=""
