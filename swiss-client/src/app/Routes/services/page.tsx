                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        ...
                        <div className='overflow-hidden'>
                            ...
                            <img style={{ transition: '.3s' }} src="https://images.unsplash.com/photo-1483683804023-6ccdb62f86ef?q=80&w=1935&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Product screenshot" className="w-[48rem] hover:scale-110 max-w-none rounded-xl shadow-xl ring-1 ring-gray-400/10 sm:w-[57rem] md:-ml-4 lg:-ml-0" width="2432" height="1442" />
                        </div>
                    </div>
                </div>
            </section>
                            ...
                            <div className="flex items-center justify-center -mx-4 lg:pl-8">
                                <div className="flex flex-col items-end px-3 overflow-hidden rounded">
                                    <img style={{ transition: ".2s linear" }}
                                        ...
                                        src="https://hamariweb.com/profiles/images/profile/9110-483.jpg"
                                        alt=""
                                    />
                                    <img style={{ transition: ".2s linear" }}
                                        className="object-cover w-20 h-20 rounded shadow-lg sm:h-32 xl:h-40 sm:w-32 xl:w-40 hover:scale-110"
                                        src="https://i.pinimg.com/474x/7e/d9/0d/7ed90d1c81c235eb189e38e41591ca36.jpg"
                                        alt=""
                                    />
                                </div>
                                <div className="px-3 overflow-hidden rounded">
                                    <img style={{ transition: ".2s linear" }}
                                        ...
                                        src="https://hamariweb.com/profiles/images/profile/7719-091-49.jpg"
                                        alt=""
                                    />
                                </div>
                            </div>
        ...
        <div className="justify-center flex-1 max-w-6xl py-4 mx-auto lg:py-6 md:px-6">
            ...
            <div className="flex flex-wrap items-center">
                ...
                <div  className="relative w-full overflow-hidden rounded-3xl px-4 mb-10 md:w-1/2 lg:mb-0">
                    <img style={{transition:".3s linear"}}  src="https://images.unsplash.com/photo-1642341185205-8e538ad2994c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt=""
