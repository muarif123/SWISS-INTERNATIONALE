          ...
          <div className="flex items-stretch justify-center">
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                <p style={{marginLeft:"14px"}} className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                  ...
                  <div className="mb-6">
                    <div className="mx-0 mb-1 sm:mb-4">
                      ...
                      <div className="mx-0 mb-1 sm:mb-4">
                        ...
                        <input
                          className="ms-5 w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          type="checkbox"
                        />{" "}
                        <label
                          className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                      ...
                      <div className="  mx-0 mb-1 sm:mb-4">
                        ...
                        <input
                          className="w-4 h-4 ms-5 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                          type="checkbox"
                        />{" "}
                        <label
                          className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300"
