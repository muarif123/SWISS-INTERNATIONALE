                    ...
                    <div className="grid sm:grid-cols-2 sm:items-center gap-8">
                        <div className="sm:order-2">
                            <div className="relative pt-[50%] sm:pt-[100%] rounded-3xl overflow-hidden">
                                <img style={{ transition: '.3s linear' }} className="w-full h-full absolute top-0 start-0 object-cover rounded-3xl hover:scale-110" src="https://images.unsplash.com/photo-1520116468816-95b69f847357?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Image Description" />
                            </div>
                        </div>
