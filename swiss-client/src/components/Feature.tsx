        ...
        <div className="grid gap-5 row-gap-10 lg:grid-cols-2">
          ...
          <div className='overflow-hidden rounded-3xl'>
            <img style={{ transition: ".3s linear all" }}
              ...
              src="https://images.unsplash.com/photo-1517176642928-dfc2da661b3f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt=""
            />
          </div>
        </div>
