      ...
      <div className="flex items-center justify-center -mx-4 lg:pl-8">
        <div className="flex flex-col items-end px-3 overflow-hidden rounded">
          <img style={{transition:".2s linear"}}
            ...
            src="https://images.unsplash.com/photo-1473625247510-8ceb1760943f?q=80&w=2011&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt=""
          />
          <img style={{transition:".2s linear"}}
        ...
        <div   className="px-3 overflow-hidden rounded">
          <img style={{transition:".2s linear"}}
            ...
            src="https://images.unsplash.com/photo-1510917181191-85abe24b5300?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8dHJhdmVsJTIwYWdlbmN5fGVufDB8fDB8fHww"
            alt=""
          />
        </div>
      </div>
